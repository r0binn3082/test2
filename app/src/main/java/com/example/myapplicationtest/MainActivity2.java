...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        questionsList.add(new Question("trois",R.drawable.five , R.drawable.three,2));
        questionsList.add(new Question("cinq", R.drawable.five, R.drawable.two,1));
        questionsList.add(new Question("quatre",R.drawable.Four, R.drawable.three, 1));
        questionsList.add(new Question( "une",R.drawable.one, R.drawable.six,1));
        questionsList.add(new Question("deux", R.drawable.one , R.drawable.two, 1));
